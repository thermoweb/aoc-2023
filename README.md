...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `83.4µs` | `927.2µs` |
| [Day 2](./src/bin/02.rs) | `122.7µs` | `123.6µs` |
| [Day 3](./src/bin/03.rs) | `1.5ms` | `1.5ms` |
| [Day 4](./src/bin/04.rs) | `170.6µs` | `195.6µs` |
| [Day 5](./src/bin/05.rs) | `29.4µs` | `79.0µs` |
| [Day 6](./src/bin/06.rs) | `247.0ns` | `417.0ns` |
| [Day 7](./src/bin/07.rs) | `311.4µs` | `310.8µs` |
