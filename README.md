...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `84.0µs` | `914.7µs` |
| [Day 2](./src/bin/02.rs) | `126.0µs` | `123.6µs` |
| [Day 3](./src/bin/03.rs) | `1.5ms` | `1.5ms` |
| [Day 4](./src/bin/04.rs) | `172.0µs` | `193.6µs` |
| [Day 5](./src/bin/05.rs) | `28.7µs` | `76.2µs` |
| [Day 6](./src/bin/06.rs) | `268.0ns` | `414.0ns` |
| [Day 7](./src/bin/07.rs) | `364.1µs` | `324.2µs` |
